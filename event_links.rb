...
module FrcLinks
  class Server < Sinatra::Base
    ...
    get /^\/(e|event)\/(q|quals?|qualifications?|s|m)\/([A-Za-z]+\d?)(\/(\d+))?$/ do
    ...
    get /^\/(e|event)\/(p|playoffs?|e|elims?|eliminations?)\/([A-Za-z]+\d?)(\/(\d+))?$/ do
      event = params["captures"][2]
      year = params["captures"][4] || default_year
    ...
    get /^\/(e|event)\/(r|rankings?|standings?)\/([A-Za-z]+\d?)(\/(\d+))?$/ do
      event = params["captures"][2]
      year = params["captures"][4] || default_year
    ...
    get /^\/(e|event)\/(a|awards?|standings?)\/([A-Za-z]+\d?)(\/(\d+))?$/ do
      event = params["captures"][2]
      year = params["captures"][4] || default_year
    ...
    get /^\/(e|event)\/(g|agenda)\/([A-Za-z]+\d?)(\/(\d+))?$/ do
      event = params["captures"][2]
      year = params["captures"][4] || default_year
    ...
    get /^\/(e|event)\/(t|tba)\/([A-Za-z]+\d?)(\/(\d+))?$/ do
      event = params["captures"][2]
      year = params["captures"][4] || default_year
